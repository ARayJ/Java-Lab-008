...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (!selection.equalsIgnoreCase("q")) {
            System.out.printf("%nPlease enter a filepath or press Q to quit: ");
            ...
            if (!selection.equalsIgnoreCase("q")) {
                ...
                boolean skipWs = (in.nextLine().equalsIgnoreCase("Y"));
                // Write a loop that will ask the user to enter a file path to g
                //gather stats on,
                ...
                try {
                    ...
                    String absoluteFileName = fs.getFileName();
                    System.out.printf("lines - %d, words - %d, chars - %d, %s", numLines, numWords, numChars, absoluteFileName);
